...
import net.wavedk.extrautilitiesreutilized.world.inventory.EFurnaceGUIMenu;
import net.wavedk.extrautilitiesreutilized.procedures.*;
import net.wavedk.extrautilitiesreutilized.network.EFurnaceGUIButtonMessage;
...
public class EFurnaceGUIScreen extends AbstractContainerScreen<EFurnaceGUIMenu> implements EuruModScreens.ScreenAccessor {
	...
	private static final ResourceLocation SPRITE_1 = ResourceLocation.parse("euru:textures/screens/arrowstrip.png");
	private static final ResourceLocation IMAGE_0 = ResourceLocation.parse("euru:textures/screens/subackdrop.png");
	private static final ResourceLocation IMAGE_1 = ResourceLocation.parse("euru:textures/screens/symbol_cross.png");
	private static final ResourceLocation IMAGE_2 = ResourceLocation.parse("euru:textures/screens/button-gun.png");
	private static final ResourceLocation IMAGE_3 = ResourceLocation.parse("euru:textures/screens/button-always-off.png");
	private static final ResourceLocation IMAGE_4 = ResourceLocation.parse("euru:textures/screens/button-red-off.png");
	private static final ResourceLocation IMAGE_5 = ResourceLocation.parse("euru:textures/screens/button-red.png");
	private static final ResourceLocation IMAGE_6 = ResourceLocation.parse("euru:textures/screens/efurnaceoffbd.png");
	private static final ResourceLocation IMAGE_7 = ResourceLocation.parse("euru:textures/screens/efurnaceonbd.png");
	...
	public void render(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
		...
		if (SUTooltipProcedure.execute(world, x, y, z))
			if (mouseX > leftPos + 2 && mouseX < leftPos + 26 && mouseY > topPos + 38 && mouseY < topPos + 62) {
				guiGraphics.renderTooltip(font, Component.translatable("gui.euru.e_furnace_gui.tooltip_speed_upgrades"), mouseX, mouseY);
				customTooltipShown = true;
			}
	...
	protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int mouseX, int mouseY) {
		...
		guiGraphics.blit(SPRITE_1, this.leftPos + 77, this.topPos + 32, 0, Mth.clamp((int) ReturnArrowStripProcedure.execute(world, x, y, z) * 22, 0, 484), 22, 22, 22, 506);
		if (SUTooltipProcedure.execute(world, x, y, z)) {
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.euru.e_furnace_gui.label_resonator"), 4, 4, -12829636, false);
	}
	...
	public void init() {
		...
		imagebutton_blank_x20 = new ImageButton(this.leftPos + 4, this.topPos + 16, 20, 20, new WidgetSprites(ResourceLocation.parse("euru:textures/screens/blank_x20.png"), ResourceLocation.parse("euru:textures/screens/blank_whiteborder_x20.png")),
				e -> {
					int x = EFurnaceGUIScreen.this.x;
					int y = EFurnaceGUIScreen.this.y;
					if (true) {
						PacketDistributor.sendToServer(new EFurnaceGUIButtonMessage(0, x, y, z));
						EFurnaceGUIButtonMessage.handleButtonAction(entity, 0, x, y, z);
					}
				}) {
			@Override
