...
public class FGenGUIScreen extends AbstractContainerScreen<FGenGUIMenu> implements EuruModScreens.ScreenAccessor {
	...
	private static final ResourceLocation IMAGE_30 = ResourceLocation.parse("euru:textures/screens/fgenbackdrop2-off.png");
	private static final ResourceLocation IMAGE_31 = ResourceLocation.parse("euru:textures/screens/fgenbackdrop2-on.png");
	...
	public void render(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
		...
		if (TooMuchGPProcedure.execute(world, x, y, z))
			if (mouseX > leftPos + 89 && mouseX < leftPos + 113 && mouseY > topPos + 31 && mouseY < topPos + 55) {
				guiGraphics.renderTooltip(font, Component.translatable("gui.euru.f_gen_gui.tooltip_not_enough_grid_power_available"), mouseX, mouseY);
				customTooltipShown = true;
			}
