...
import net.wavedk.extrautilitiesreutilized.network.EGenGUIButtonMessage;
...
public class EGenGUIScreen extends AbstractContainerScreen<EGenGUIMenu> implements EuruModScreens.ScreenAccessor {
	...
	private static final ResourceLocation IMAGE_23 = ResourceLocation.parse("euru:textures/screens/sgenbackdrop2-on.png");
	private static final ResourceLocation IMAGE_24 = ResourceLocation.parse("euru:textures/screens/sgenbackdrop2-off.png");
	...
	public EGenGUIScreen(EGenGUIMenu container, Inventory inventory, Component text) {
	...
	public void render(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
		...
		if (mouseX > leftPos + 140 && mouseX < leftPos + 164 && mouseY > topPos + 7 && mouseY < topPos + 31) {
		...
		if (mouseX > leftPos + 140 && mouseX < leftPos + 164 && mouseY > topPos + 30 && mouseY < topPos + 54) {
			String hoverText = ReturnFEStorageProcedure.execute(world, x, y, z);
			if (hoverText != null) {
				guiGraphics.renderComponentTooltip(font, Arrays.stream(hoverText.split("\n")).map(Component::literal).collect(Collectors.toList()), mouseX, mouseY);
			}
		...
		if (mouseX > leftPos + 140 && mouseX < leftPos + 164 && mouseY > topPos + 53 && mouseY < topPos + 77) {
			String hoverText = ReturnFEStorageProcedure.execute(world, x, y, z);
			if (hoverText != null) {
				guiGraphics.renderComponentTooltip(font, Arrays.stream(hoverText.split("\n")).map(Component::literal).collect(Collectors.toList()), mouseX, mouseY);
			}
