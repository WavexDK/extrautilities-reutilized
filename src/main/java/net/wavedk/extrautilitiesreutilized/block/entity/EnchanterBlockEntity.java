...
public class EnchanterBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer, IEnergyReceiver {
	...
	public EnchanterBlockEntity(BlockPos position, BlockState state) {
		super(EuruModBlockEntities.ENCHANTER.get(), position, state);
	}
