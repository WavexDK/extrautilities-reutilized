...
public class CGenRecipeTypeRecipeCategory implements IRecipeCategory<CGenRecipeTypeRecipe> {
	public final static ResourceLocation UID = ResourceLocation.parse("euru:c_gen_recipe_type");
	public final static ResourceLocation TEXTURE = ResourceLocation.parse("euru:textures/screens/cgenbg.png");
	private final IDrawable background;
	private final IDrawable icon;
	private final Minecraft mc = Minecraft.getInstance();

	public CGenRecipeTypeRecipeCategory(IGuiHelper helper) {
		this.background = helper.createDrawable(TEXTURE, 0, 0, 180, 80);
		this.icon = helper.createDrawableIngredient(VanillaTypes.ITEM_STACK, new ItemStack(EuruModBlocks.CULINARY_GENERATOR.get().asItem()));
	}

	@Override
	public mezz.jei.api.recipe.RecipeType<CGenRecipeTypeRecipe> getRecipeType() {
		return EuruModJeiPlugin.CGenRecipeType_Type;
	}
	...
	@Override
	public void draw(CGenRecipeTypeRecipe recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics guiGraphics, double mouseX, double mouseY) {
	...
	public void getTooltip(ITooltipBuilder tooltip, CGenRecipeTypeRecipe recipe, IRecipeSlotsView recipeSlotsView, double mouseX, double mouseY) {
	...
	@Override
	public void setRecipe(IRecipeLayoutBuilder builder, CGenRecipeTypeRecipe recipe, IFocusGroup focuses) {
