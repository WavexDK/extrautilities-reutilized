...
public class EURUUnifiedConfigManagerProcedure {
	...
	private static void execute(@Nullable Event event) {
		...
		com.google.gson.JsonObject spikes = new com.google.gson.JsonObject();
		com.google.gson.JsonObject woodenspike = new com.google.gson.JsonObject();
		com.google.gson.JsonObject sspike = new com.google.gson.JsonObject();
		com.google.gson.JsonObject is = new com.google.gson.JsonObject();
		...
		if (!configFile.exists()) {
			...
			itemobj.addProperty("needs_block_id", "minecraft:air");
			...
			itemobj = new com.google.gson.JsonObject();
			itemobj.addProperty("gp_generated", 2);
			itemobj.addProperty("needs_sky", false);
			itemobj.addProperty("needs_time_min", 0);
			itemobj.addProperty("needs_time_max", 24000);
			...
			itemobj.addProperty("needs_time_max", 24000);
			itemobj.addProperty("needs_block", true);
			itemobj.addProperty("needs_block_id", "minecraft:fire");
			variantArray = new com.google.gson.JsonArray();;
			variantArray.add("down");
			itemobj.add("needs_block_sides", variantArray);
			...
			itemobj.addProperty("needs_time_max", 24000);
			itemobj.addProperty("needs_block", true);
			itemobj.addProperty("needs_block_id", "minecraft:lava");
			variantArray = new com.google.gson.JsonArray();;
			variantArray.add("north");
			variantArray.add("south");
			variantArray.add("west");
			variantArray.add("east");
			itemobj.add("needs_block_sides", variantArray);
			...
			itemobj.addProperty("needs_time_max", 24000);
			itemobj.addProperty("needs_block", true);
			itemobj.addProperty("needs_block_id", "minecraft:water");
			variantArray = new com.google.gson.JsonArray();;
			variantArray.add("north");
			variantArray.add("south");
			variantArray.add("west");
			...
			woodenspike.addProperty("damage_byplayer", false);
			woodenspike.addProperty("damage_booster_block", (BuiltInRegistries.ITEM.getKey(Blocks.OAK_WOOD.asItem()).toString()));
			spikes.add((BuiltInRegistries.ITEM.getKey(EuruModBlocks.WOODEN_SPIKE.get().asItem()).toString()), woodenspike);
			sspike.addProperty("damage_tick", 2);
			sspike.addProperty("damage_tickrate", 15);
			sspike.addProperty("damage_byplayer", true);
			sspike.addProperty("damage_booster_block", (BuiltInRegistries.ITEM.getKey(EuruModBlocks.COMPRESSED_COBBLESTONE.get().asItem()).toString()));
			spikes.add((BuiltInRegistries.ITEM.getKey(EuruModBlocks.STONE_SPIKE.get().asItem()).toString()), sspike);
			is.addProperty("damage_tick", 3);
			is.addProperty("damage_tickrate", 12);
			is.addProperty("damage_byplayer", true);
			is.addProperty("damage_booster_block", (BuiltInRegistries.ITEM.getKey(Blocks.IRON_BLOCK.asItem()).toString()));
			spikes.add((BuiltInRegistries.ITEM.getKey(EuruModBlocks.IRON_SPIKE.get().asItem()).toString()), is);
			gs.addProperty("damage_tick", 2);
			gs.addProperty("damage_tickrate", 2);
			gs.addProperty("damage_byplayer", true);
			gs.addProperty("damage_booster_block", (BuiltInRegistries.ITEM.getKey(Blocks.GOLD_BLOCK.asItem()).toString()));
			spikes.add((BuiltInRegistries.ITEM.getKey(EuruModBlocks.GOLD_SPIKE.get().asItem()).toString()), gs);
			dias.addProperty("damage_tick", 8);
			dias.addProperty("damage_tickrate", 8);
			dias.addProperty("damage_byplayer", true);
			dias.addProperty("damage_booster_block", (BuiltInRegistries.ITEM.getKey(Blocks.DIAMOND_BLOCK.asItem()).toString()));
			spikes.add((BuiltInRegistries.ITEM.getKey(EuruModBlocks.DIAMOND_SPIKE.get().asItem()).toString()), dias);
			nspike.addProperty("damage_tick", 12);
			nspike.addProperty("damage_tickrate", 4);
			nspike.addProperty("damage_byplayer", true);
			nspike.addProperty("damage_booster_block", (BuiltInRegistries.ITEM.getKey(Blocks.NETHERITE_BLOCK.asItem()).toString()));
			spikes.add((BuiltInRegistries.ITEM.getKey(EuruModBlocks.NETHERITE_SPIKE.get().asItem()).toString()), nspike);
			configJsonObject.add("spikes", spikes);
