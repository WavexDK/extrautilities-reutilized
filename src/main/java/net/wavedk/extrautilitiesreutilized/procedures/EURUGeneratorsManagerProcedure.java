...
public class EURUGeneratorsManagerProcedure {
	public static void execute() {
		...
		if (!configFile.exists()) {
			...
			cItemOBJ = new com.google.gson.JsonObject();
			cItemOBJ.addProperty("feGenerated", 64000);
			...
			cItemOBJ = new com.google.gson.JsonObject();
			cItemOBJ.addProperty("feGenerated", 7200);
			cItemOBJ.addProperty("feSpeed", 32);
			cgenfp.add(cItem, cItemOBJ);
			cgenarray.add(cItem);
			...
			cItemOBJ = new com.google.gson.JsonObject();
			cItemOBJ.addProperty("feGenerated", 12800);
			cItemOBJ.addProperty("feSpeed", 48);
			cgenfp.add(cItem, cItemOBJ);
			cgenarray.add(cItem);
			...
			cItemOBJ = new com.google.gson.JsonObject();
			cItemOBJ.addProperty("feGenerated", 2400);
