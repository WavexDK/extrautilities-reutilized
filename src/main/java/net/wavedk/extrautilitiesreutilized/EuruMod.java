package net.wavedk.extrautilitiesreutilized;

import org.apache.logging.log4j.Logger;
import org.apache.logging.log4j.LogManager;

import net.wavedk.extrautilitiesreutilized.network.EuruModVariables;
import net.wavedk.extrautilitiesreutilized.init.*;
...
@Mod("euru")
public class EuruMod {
	public static final Logger LOGGER = LogManager.getLogger(EuruMod.class);
	public static final String MODID = "euru";

	public EuruMod(IEventBus modEventBus) {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		NeoForge.EVENT_BUS.register(this);
		modEventBus.addListener(this::registerNetworking);
		if (ModList.get().isLoaded("curios")) {
			modEventBus.addListener(EuruModCuriosCompat::registerCapabilities);
		}
		EuruModBlocks.REGISTRY.register(modEventBus);
		EuruModBlockEntities.REGISTRY.register(modEventBus);
